...
peer chaincode invoke -o $ORDERER_ADDRESS --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $CC_NAME -c '{ "Args": ["TransferPaymentsToSpv","[\"7bcfd178b2058a49a0381740befabca3f9c5bb3c032c7b437fd67a5c8be81bb1:0\"]","eDUwOTo6Q049c3B2LWNsaWVudCxPVT1jbGllbnQrT1U9c3B2K09VPWNsaWVudGUsTz1TUFYsTD1TUFZMb2NhdGlvbixTVD1TUFZTdGF0ZSxDPVNQOjpDTj1yb290Y2Etc3B2LE9VPUh5cGVybGVkZ2VyIEZhYnJpYyxPPVNQVixMPVNQVkwsU1Q9U1BWU1QsQz1TUA=="] }' --peerAddresses $CORE_PEER_ADDRESS --peerAddresses localhost:9051 --peerAddresses localhost:8051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE --tlsRootCertFiles  $(cd .. && echo $PWD/fabric-ca/aggregator/peers/aggregator-peer/tls/ca.crt) --tlsRootCertFiles  $(cd .. && echo $PWD/fabric-ca/farmer/peers/farmer-peer/tls/ca.crt)
