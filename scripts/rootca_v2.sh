...
export FABRIC_CA_CLIENT_TLS_CERTFILES=$NEW_PATH/network/fabric-ca/originator/ca/tls-cert.pem
# Inscribimos la identidad de arranque de la CA
fabric-ca-client enroll -u https://rootca-originator-admin:rootca-originator-adminpw@localhost:7055 --tls.certfiles $FABRIC_CA_CLIENT_TLS_CERTFILES --csr.names "$CSR_NAMES_ORIGINATOR"
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=$NEW_PATH/network/fabric-ca/originator/tls-ca/tls-cert.pem
export FABRIC_CA_CLIENT_HOME=$NEW_PATH/network/fabric-ca/originator/tls-ca/clients/admin
fabric-ca-client enroll -u https://tls-ca-originator-admin:tls-ca-originator-adminpw@localhost:7054 --tls.certfiles $FABRIC_CA_CLIENT_TLS_CERTFILES --csr.names "$CSR_NAMES_ORIGINATOR"
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=$NEW_PATH/network/fabric-ca/underwritter/ca/tls-cert.pem
# Inscribimos la identidad de arranque de la CA
fabric-ca-client enroll -u https://rootca-underwritter-admin:rootca-underwritter-adminpw@localhost:11055 --tls.certfiles $FABRIC_CA_CLIENT_TLS_CERTFILES --csr.names "$CSR_NAMES_UNDERWRITTER"
...
# Inscribimos la identidad de arranque de la TLS CA
export FABRIC_CA_CLIENT_TLS_CERTFILES=$NEW_PATH/network/fabric-ca/underwritter/tls-ca/tls-cert.pem
export FABRIC_CA_CLIENT_HOME=$NEW_PATH/network/fabric-ca/underwritter/tls-ca/clients/admin
fabric-ca-client enroll -u https://tls-ca-underwritter-admin:tls-ca-underwritter-adminpw@localhost:11054 --tls.certfiles $FABRIC_CA_CLIENT_TLS_CERTFILES --csr.names "$CSR_NAMES_UNDERWRITTER"
